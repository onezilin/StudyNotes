...
```bash
# 将 6385 节点添加到集群
> ./redis-cli --cluster add-node 192.168.190.134:6385 192.168.190.134:6379
# 客户端连接 6385 节点
> /redis-cli -h 192.168.190.134 -p 6385
# 查看当前集群的节点信息
> CLUSTER NODES
# 将 6385 节点作为 6379
> CLUSTER REPLICATE 8965795852911480dbb181c5149974e2567b1cd3
```
...
### （三）[哨兵模式](https://www.cnblogs.com/kevingrace/p/9004460.html)
